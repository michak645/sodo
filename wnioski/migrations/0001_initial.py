# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-01-05 01:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrator_obiektu', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auth_ex.Pracownik')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data', models.DateTimeField(auto_now=True, verbose_name='Data')),
                ('typ', models.CharField(choices=[('1', 'Nadanie uprawnień'), ('2', 'Odebranie uprawnień')], default='1', max_length=1, verbose_name='Typ')),
                ('uprawnienia', multiselectfield.db.fields.MultiSelectField(choices=[('1', 'Wgląd'), ('2', 'Tworzenie'), ('3', 'Modyfikacja'), ('4', 'Przetwarzanie na serwerze i w biurze'), ('5', 'Przechowywanie'), ('6', 'Usuwanie, niszczenie'), ('7', 'Udostępnianie, powierzanie, przesyłanie')], default='1', max_length=1, verbose_name='Uprawnienia')),
                ('czy_zmienione', models.BooleanField(default=False)),
                ('komentarz', models.TextField(null=True)),
                ('obiekt', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='wnioski.Obiekt')),
